...
public class UDAFArrayVariancePop extends AbstractGenericUDAFResolver {
    ...
    public GenericUDAFEvaluator getEvaluator(GenericUDAFParameterInfo info) throws SemanticException {
        ...
        UDAFArrayVariancePopEvaluator eval = (UDAFArrayVariancePopEvaluator) getEvaluator(parameters);
    ...
    public static class UDAFArrayVariancePopEvaluator extends GenericUDAFEvaluator {
