...
public class TestArrayVarianceSample extends AbstractTestUDAFArray {

    public TestArrayVarianceSample() {
        udaf = new UDAFArrayVarianceSample();
    }
    ...
    class ByteEvaluator extends AbstractEvaluator {
        ...
        public ByteEvaluator() {
            ...
            mergedOutput = "[0.3333333333333333, 1.3333333333333333]";
        }
    }
    ...
    class FloatEvaluator extends AbstractEvaluator {
        public FloatEvaluator() {
            ...
            mergedOutput = "[0.08333333333333333, 0.3333333333333333]";
        }
    }
