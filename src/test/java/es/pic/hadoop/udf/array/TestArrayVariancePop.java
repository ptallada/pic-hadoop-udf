...
public class TestArrayVariancePop extends AbstractTestUDAFArray {

    public TestArrayVariancePop() {
        udaf = new UDAFArrayVariancePop();
    }
    ...
    class ByteEvaluator extends AbstractEvaluator {
        ...
        public ByteEvaluator() {
            ...
            outputs = new String[] {
                    "[null, null]", "[null, 0.0]", "[0.0, 0.0]", "[0.25, 1.0]", "[0.25, 1.0]"
            };
            mergedOutput = "[0.25, 1.0]";
        }
    }
    ...
    class FloatEvaluator extends AbstractEvaluator {
        public FloatEvaluator() {
            ...
            outputs = new String[] {
                    "[null, null]", "[null, 0.0]", "[0.0, 0.0]", "[0.0625, 0.25]", "[0.0625, 0.25]"
            };
            mergedOutput = "[0.0625, 0.25]";
        }
    }
