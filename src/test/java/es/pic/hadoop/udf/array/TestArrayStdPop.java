...
public class TestArrayStdPop extends AbstractTestUDAFArray {

    public TestArrayStdPop() {
        udaf = new UDAFArrayStdPop();
    }
    ...
    class ByteEvaluator extends AbstractEvaluator {
        ...
        public ByteEvaluator() {
            ...
            outputs = new String[] {
                    "[null, null]", "[null, 0.0]", "[0.0, 0.0]", "[0.5, 1.0]", "[0.5, 1.0]"
            };
            mergedOutput = "[0.5, 1.0]";
        }
    }
    ...
    class FloatEvaluator extends AbstractEvaluator {
        public FloatEvaluator() {
            ...
            outputs = new String[] {
                    "[null, null]", "[null, 0.0]", "[0.0, 0.0]", "[0.25, 0.5]", "[0.25, 0.5]"
            };
